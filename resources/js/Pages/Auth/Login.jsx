        ...
        <div className="min-h-screen bg-bg flex items-center justify-center px-4 relative">
            ...
            <div className="w-full max-w-sm auth-card">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-text text-2xl font-bold">{t('auth.login_title')}</h1>
                    <p className="text-text-muted text-sm mt-1">{t('auth.login_subtitle')}</p>
                </div>

                {status && (
                    <div className="mb-4 text-sm text-success bg-accent-soft rounded-sm px-4 py-3 border border-border">
                        {status}
                    </div>
                )}
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        {canResetPassword && (
                            <Link href={route('password.request')} className="text-accent hover:opacity-80 transition">
                ...
                <p className="text-center text-text-muted text-sm mt-6">
                    {t('auth.no_account')}{' '}
                    <Link href={route('register')} className="text-accent hover:opacity-80 transition font-medium">
