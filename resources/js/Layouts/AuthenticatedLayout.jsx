...
function DownloadBanner() {
    ...
    return (
        <div className="flex items-center justify-between gap-4 bg-accent px-4 py-2 text-sm text-text-on-accent shrink-0 border-b border-border">
            ...
            <div className="flex items-center gap-3 shrink-0">
                ...
                <button onClick={dismiss} className="text-text-on-accent/70 hover:text-text-on-accent transition" aria-label="Cerrar">
